...
// ----------------------------------------------------------------------
BOOL LoadShot(LPREGSHOT lpShot, TCHAR *filepath)
{
    OPENFILENAME opfn;
    ...
    hFileWholeReg = CreateFile(filepath, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
    if (INVALID_HANDLE_VALUE == hFileWholeReg) {
